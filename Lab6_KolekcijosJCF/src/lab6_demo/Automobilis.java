...
/**  @author EK */
public class Automobilis implements Serializable, Comparable {
    ...
    public void fromString(String autoD){
        try {   // ed - tai elementarūs duomenys, atskirti tarpais
            ...
            System.err.println("Blogas duomenų formatas apie auto -> "+ autoD);
        } catch (NoSuchElementException e) {
            System.err.println("Trūksta duomenų apie auto -> "+ autoD);
        }
    }
    @Override
...
//    public int compareTo(Automobilis a) {
    ...
    public static Comparator pagalMarkęModelį = new Comparator() {
       public int compare(Object o1, Object o2) {
          Automobilis a1 = (Automobilis) o1;
          Automobilis a2 = (Automobilis) o2;
          // pradžioje pagal markes, o po to pagal modelius
          return (a1.getMarkė()+a1.getModelis()).compareTo
                 (a2.getMarkė()+a2.getModelis());
       }
    };
